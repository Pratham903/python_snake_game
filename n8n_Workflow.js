...
if (body?.summarize_data?.repository_data) {
  ...
  const repoSummary =
    summaryData.repository_summary || "No repository summary available.";
  const commitSummary =
    summaryData.commit_summary || "No commit summary available.";
  ...
  htmlContent = `
    <h2>Manager's Summary for: ${repoName}</h2>
    <hr>
    ...
    <pre style="white-space: pre-wrap; word-wrap: break-word; font-family: monospace; background-color: white; padding: 15px; border-radius: 5px;">${repoSummary}</pre>
    
    <h3>Team Progress & Development Rhythm</h3>
    <pre style="white-space: pre-wrap; word-wrap: break-word; font-family: monospace; background-color: white; padding: 15px; border-radius: 5px;">${commitSummary}</pre>
